...
@Composable
fun AlignYourBodyElement(modifier: Modifier = Modifier, idDrawable: Int, idText: Int) {
    Column (
...
@Composable
fun FavoriteCollectionCard(modifier: Modifier = Modifier, drawable: Int, text: Int) {
    Surface (
...
fun AlignYourBodyRow(modifier: Modifier = Modifier) {
    LazyRow (
        ...
        items(alignYourBodyData){
            item -> AlignYourBodyElement(idDrawable =  item.drawable, idText = item.text)
        }
    }
}
...
fun AlignYourBodyElementPreview() {
    MySootheTheme {
        AlignYourBodyElement(
            ...
            idDrawable = R.drawable.ab1_inversions,
            idText = R.string.ab1_inversions
